...
b7 = Button(f10, text = "Home",fg="black",bg="#FFFACD", font = "Helvetica 20 bold",height=1,width=13,command=start1).place(x = 550, y = 200)
b8 = Button(f10, text = "Abstract",fg="black",bg="#FFFACD", font = "Helvetica 20 bold",height=1,width=13,command = start2).place(x = 550, y = 270)
...
b10 = Button(f10, text = "Encryption",fg="black",bg="#FFFACD", font = "Helvetica 20 bold",height=1,width=13,command=start3).place(x = 550, y = 340)
b11 = Button(f10, text = "Decryption",fg="black",bg="#FFFACD", font = "Helvetica 20 bold",height=1,width=13,command = start6).place(x = 550, y = 410)
...
lab1 = Label(f3,text="Encryption", font = "Helvetica 34 bold").place(x = 400, y = 150)



b1 = Button(f3,text='Browse Image',font = "Helvetica 12 bold",command = upload_file).place(x = 200, y = 300)
img11 =Label(f3) 
img11.place(x=700,y=100)

#l1123 = Label(f3,text='Enter P Value',font = "Helvetica 12 bold").place(x = 200, y = 350)
exe1 = Entry(f3,font = "Helvetica 12 bold")
exe1.place(x = 350, y = 300)
...
ll4 = Button(f3,text='Y Value',font = "Helvetica 12 bold",command =Y_value ).place(x = 200, y = 500)
ee4 = Entry(f3,font = "Helvetica 12 bold")
ee4.place(x = 350, y = 500)

l5 = Button(f3,text='Cipher Values',font = "Helvetica 12 bold",command = K_value).place(x = 200, y = 550)
...
Button(f3,text='Encrypt&Save',font = "Helvetica 12 bold",command=encrypt_image).place(x = 660, y = 550)
img111 =Label(f3) 
img111.place(x=700,y=320)
...
b7 = Button(f3, text = "Home",fg="black",bg="#FFFACD", font = "Helvetica 12 bold",height=1,width=10,command=start10).place(x = 860, y = 550)
...
l3 = Button(f6,text='Secert Key',font = "Helvetica 12 bold",command =Secret_Key).place(x = 200, y = 250)
e3 = Entry(f6,font = "Helvetica 12 bold")
e3.place(x = 350, y = 250)

l4 = Button(f6,text='image values',font = "Helvetica 12 bold",command =image_values).place(x = 200, y = 300)
